...
pref!(AwayReason, "away_reason", String);
...
pref!(CompletionSuffix, "completion_suffix", String);
...
pref!(GuiUlistDoubleclick, "gui_ulist_doubleclick", String);
...
pref!(InputCommandChar, "input_command_char", String);
...
pref!(IrcExtraHilight, "irc_extra_hilight", String);
...
pref!(IrcIdNtext, "irc_id_ntext", String);
pref!(IrcIdYtext, "irc_id_ytext", String);
pref!(IrcInvisible, "irc_invisible", bool);
pref!(IrcJoinDelay, "irc_join_delay", i32);
pref!(IrcLogging, "irc_logging", bool);
pref!(IrcLogmask, "irc_logmask", String);
pref!(IrcNick1, "irc_nick1", String);
pref!(IrcNick2, "irc_nick2", String);
pref!(IrcNick3, "irc_nick3", String);
pref!(IrcNickHilight, "irc_nick_hilight", String);
pref!(IrcNoHilight, "irc_no_hilight", String);
pref!(IrcNoticePos, "irc_notice_pos", i32);
pref!(IrcPartReason, "irc_part_reason", String);
pref!(IrcQuitReason, "irc_quit_reason", String);
pref!(IrcRawModes, "irc_raw_modes", bool);
pref!(IrcRealName, "irc_real_name", String);
pref!(IrcServernotice, "irc_servernotice", bool);
pref!(IrcSkipMotd, "irc_skip_motd", bool);
pref!(IrcUserName, "irc_user_name", String);
...
pref!(StampLogFormat, "stamp_log_format", String);
pref!(StampText, "stamp_text", bool);
pref!(StampTextFormat, "stamp_text_format", String);
...
pref!(TextBackground, "text_background", String);
pref!(TextColorNicks, "text_color_nicks", bool);
pref!(TextFont, "text_font", String);
pref!(TextFontMain, "text_font_main", String);
pref!(TextFontAlternative, "text_font_alternative", String);
...
pref!(TextSpellLangs, "text_spell_langs", String);
